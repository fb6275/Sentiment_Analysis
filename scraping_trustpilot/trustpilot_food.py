...
# take other page of the category for more shop

# page 2
food_two = 'https://fr.trustpilot.com/categories/food_beverages_tobacco?page=2'

# page 3
food_three = 'https://fr.trustpilot.com/categories/food_beverages_tobacco?page=3'

# page 4
food_four = 'https://fr.trustpilot.com/categories/food_beverages_tobacco?page=4'

"""BEGIN"""
# page 1

driver.get(food)  # take the url food
...
print(commerces_link)
commerces_link = commerces_link[:40]
print(commerces_link)

# page 3

driver.get(food_three)
...
print(commerces_link)
commerces_link = commerces_link[:60]
print(commerces_link)

# page 4

driver.get(food_four)
...
print(commerces_link)
commerces_link = commerces_link[:80]
print(commerces_link)
...
print(df)
df.to_csv('food_drink_smoke.csv')  # transform the dataframe in csv
